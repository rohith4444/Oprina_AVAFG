...
const PublicContactPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://dgjgvhjybomaiigmrehc.supabase.co/functions/v1/contact-form', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRnamd2aGp5Ym9tYWlpZ21yZWhjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDgwODI1MTQsImV4cCI6MjA2MzY1ODUxNH0.uu3DVwZ1ZBGAWKx74M9kV3WiJQ7bwG1P6oHPLjApSBg',
        },
        body: JSON.stringify({
