...
// Add this line after the existing Deno declarations
const SITE_URL = Deno.env.get('VITE_SITE_URL') || 'https://www.oprinaai.com';
...
Deno.serve(async (req) => {
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="cta-section">
              <a href="${SITE_URL}/get-started" class="cta-button">Get Started with Oprina</a>
            </div>
  ...
  🚀 Get Started with Oprina: ${SITE_URL}/get-started
